...
export const finalIsland = {
  ...
  arrival: {
    ...
    lines: [
      {
        vi: 'You cân hết cả 4 hòn đảo rồi. Chỉ còn một thử thách cuối.',
        en: "You've conquered all 4 islands. One last trial left.",
      },
      { vi: 'Giờ tự sắp xếp lại hành trình của chính you đi.', en: 'Now put your own journey back in order.' },
    ],
    secretLines: [
      {
  ...
  discovery: {
    ...
    story: [
      {
        vi: 'Từng mảnh la bàn you gom được giờ hội tụ hết rồi. Sắp đúng thứ tự là xong.',
  ...
  lessons: [
    {
      id: 'level5-sequence',
      type: 'sequence',
      prompt: { vi: 'Sắp xếp lại đúng thứ tự các hòn đảo you đã đi qua:', en: "Arrange the islands you've been through in the right order:" },
      secretPrompt: {
        vi: 'Sắp lại đúng thứ tự các hòn đảo — you mà sắp sai, tao cạy mồm you ra cười cả năm luôn đó!!!:',
  ...
  ending: {
    speaker: GUIDE,
    lines: [
      { vi: 'Ngon, you hoàn thành hành trình rồi đó!', en: "Nice — you finished the whole damn journey!" },
      {
        vi: 'You cân hết mọi thử thách bằng chính sự lì lợm và thông minh của you.',
